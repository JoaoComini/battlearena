...
#[cfg(feature = "client")]
use crate::client::{connect, ClientTransports, BattleArenaClient};
#[cfg(all(any(feature = "gui2d", feature = "gui3d"), feature = "client"))]
use crate::renderer::client::BattleArenaClientRendererPlugin;
#[cfg(all(any(feature = "gui2d", feature = "gui3d"), feature = "server"))]
use crate::renderer::server::BattleArenaServerRendererPlugin;
#[cfg(feature = "server")]
use crate::server::{start, BattleArenaServer, ServerTransports};
...
pub fn window_plugin() -> WindowPlugin {
    WindowPlugin {
        primary_window: Some(Window {
            title: format!("BattleArena: {}", env!("CARGO_PKG_NAME")),
