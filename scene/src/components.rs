...
/// Asset path to a mesh within a GLTF file (e.g. `"models/arena.glb#Mesh0/Primitive0"`).
...
/// Asset path to a material within a GLTF file (e.g. `"models/arena.glb#Material0"`).
